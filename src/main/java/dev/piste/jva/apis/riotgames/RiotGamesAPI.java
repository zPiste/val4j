...
import dev.piste.jva.apis.riotgames.exceptions.InvalidParameterException;
import dev.piste.jva.apis.riotgames.models.RiotAccount;
...
public class RiotGamesAPI {
    ...
    public RiotAccount getAccount(String name, String tag) throws IOException {
        try {
            RestRequest request = new GetRequest().addPath("account").addPath("v1")
